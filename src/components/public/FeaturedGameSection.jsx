...
import { Download, Github, Gamepad2, Star, ShieldAlert, ArrowRight, Sparkles, Cpu, Layers } from 'lucide-react';
  ...
  return (
    <section id="game-feature" className="relative min-h-[85vh] flex items-center justify-center py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#070913] via-[#0b0e21] to-[#070913] border-t border-cyan-500/30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="neon-card p-6 sm:p-8 lg:p-10 border-cyan-500/40 relative overflow-hidden bg-slate-950/80 backdrop-blur-xl shadow-[0_0_35px_rgba(0,243,255,0.15)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex justify-center">
              <div className="relative group max-w-[200px] sm:max-w-[230px] w-full">
                ...
                {/* Outer Ambient Glow */}
                <div className="absolute -inset-1 rounded-[34px] bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 opacity-75 blur-xl group-hover:opacity-100 transition-opacity duration-500 animate-pulse" />

                {/* Game Icon Container */}
                <div className="relative rounded-[28px] overflow-hidden bg-slate-950/90 border-4 border-cyan-400/90 shadow-[0_0_30px_rgba(0,243,255,0.4)] aspect-square p-2.5 flex items-center justify-center">
                  <img
            ...
            <div className="lg:col-span-8 space-y-4 text-left">
              ...
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 border border-cyan-500/40 px-3.5 py-1.5 rounded-full shadow-[0_0_15px_rgba(0,243,255,0.2)]">
                ...
                <span className="text-xs font-bold text-cyan-300 tracking-wider uppercase">
                  FEATURED DEVELOPER APPS & GAMES • EDP UNIVERSE
                </span>
              </div>
              ...
              <div>
                <h2 className="font-['Creato_Display'] text-2xl sm:text-4xl font-extrabold text-white tracking-tight leading-tight">
                  FE Apps Suite & <span className="text-gradient">Tic Tac Toe: GenZ</span>
                </h2>
                ...
                <div className="flex flex-wrap items-center gap-2.5 pt-1.5 text-xs sm:text-sm">
                  ...
                  <span className="text-slate-300">Software & Mobile Apps Suite</span>
                  <span className="text-slate-600">•</span>
              ...
              <p className="text-slate-300 text-xs sm:text-sm leading-relaxed max-w-2xl">
                Discover our engineered software products — including <strong className="text-cyan-300 font-bold">FE Player (Desktop & Mobile)</strong>, <strong className="text-emerald-300 font-bold">MessManager Pro</strong>, and <strong className="text-yellow-300 font-bold">Tic Tac Toe: GenZ Multiplayer</strong> (100 Feni Villages Map).
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                >
                  ...
                  <span>Download Game APK</span>
                </a>

                {/* PROMINENT "Explore FE Apps & Software Showcase" Button */}
                <button
                  onClick={onOpenGameDetails}
                  className="bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 hover:from-cyan-500/30 hover:to-purple-500/30 text-cyan-300 border border-cyan-400/60 font-bold text-xs sm:text-sm py-3 px-5 rounded-xl flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(0,243,255,0.25)] transition-all group cursor-pointer"
                >
                  <Sparkles className="w-4 h-4 text-cyan-400" />
                  <span>Explore FE Apps & Software Suite 🚀</span>
              ...
              <div className="pt-2 flex items-center gap-2 text-[11px] text-slate-400 font-mono">
                ...
                <span>Verified Direct Downloads (v1.0.1) • Safe APK, EXE & DMG files</span>
              </div>
